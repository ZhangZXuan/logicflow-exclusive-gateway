...
exports.PoolElements = exports.LaneNode = exports.PoolNode = void 0;
var core_1 = require("@logicflow/core");
var lodash_es_1 = require("lodash-es");
var PoolModel_1 = require("./PoolModel");
var PoolView_1 = require("./PoolView");
var LaneModel_1 = require("./LaneModel");
var LaneView_1 = require("./LaneView");
var utils_1 = require("./utils");
exports.PoolNode = {
    type: 'pool',
    view: PoolView_1.PoolView,
    model: PoolModel_1.PoolModel,
};
exports.LaneNode = {
    type: 'lane',
    view: LaneView_1.LaneView,
    model: LaneModel_1.LaneModel,
};
var PoolElements = /** @class */ (function () {
    function PoolElements(_a) {
        ...
        this.addNodeToGroup = function (node) {
            ...
            if (nodeModel && bounds) {
                ...
                if (nodeModel.isGroup) {
                    ...
                    (0, lodash_es_1.forEach)(Array.from(lane_1.children), function (childId) {
        ...
        lf.register(exports.PoolNode);
        lf.register(exports.LaneNode);
        this.lf = lf;
    ...
    PoolElements.prototype.getLaneByBounds = function (bounds, nodeData) {
        ...
        var lanes = (0, lodash_es_1.filter)(nodes, function (node) {
            return (!!node.isGroup &&
                (0, utils_1.isBoundsInLane)(bounds, node) &&
                node.id !== nodeData.id);
        });
...
exports.PoolElements = PoolElements;
exports.default = PoolElements;
